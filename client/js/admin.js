(function () {
  ...
  function fillSettingsForms(settings) {
    ...
    const addonsEl = app.querySelector('[name="addons_enabled"]');
    if (addonsEl) addonsEl.value = String(toBool(settings.addons_enabled, true));
  ...
  async function saveAppSettings(event) {
    ...
    const payload = {
      ...
      ,
      addons_enabled: (function () {
        const el = form.querySelector('[name="addons_enabled"]');
